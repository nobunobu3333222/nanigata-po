...
export function Footer() {
  return <footer className="site-footer"><Link href="/" className="wordmark small">何型っぽ？</Link><nav className="footer-nav" aria-label="サービス情報"><Link href="/blood-type">血液型の性格・特徴</Link><Link href="/about">サービスについて</Link><Link href="/privacy">プライバシーポリシー</Link><a href={CONTACT_FORM_URL}>お問い合わせ（Googleフォーム）</a></nav><Disclaimer /><p className="fine">© 何型っぽ？</p></footer>;
}
